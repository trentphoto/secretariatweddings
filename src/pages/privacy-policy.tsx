        ...
        <main>
          <section className='py-24'>
            <div className='content container'>
              ...
              <ul>
                <li>
                  At Secretariat Media, LLC (hereafter referred to as
                  “Secretariat”), accessible from www.secretariat.video, one of
                  our main priorities is the privacy of our visitors. This
                  Privacy Policy document contains types of information that is
                  collected and recorded by Secretariat and how we use it.
                </li>
                <li>
                ...
                <li>
                  ...
                  information that they shared and/or collect in Secretariat.
              ...
              <h2>Log Files</h2>
              <p>
                Secretariat follows a standard procedure of using log files.
              ...
              <ul>
                <li>
                  ...
                  of the advertising partners of Secretariat.
                </li>
                <li>
                  Third-party ad servers or ad networks uses technologies like
                  cookies, JavaScript, or Web Beacons that are used in their
                  respective advertisements and links that appear on
                  Secretariat, which are sent directly to users' browser. They
                ...
                <li>
                  Note that Secretariat has no access to or control over these
              ...
              <ul>
                <li>
                  Secretariat's Privacy Policy does not apply to other
              ...
              <ul>
                ...
                <li>
                  Secretariat does not knowingly collect any Personal
